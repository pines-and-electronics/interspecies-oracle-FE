  ...
  return (
    <div className={classes.root}>
      <div className={classes.vertical}>
        ...
        <br />
        {/* Load poem */}
        <q className={classes.textPoem}>
          Oh, bug on a leaf, thine legs are so fuzzy. As the celestial spheres align, I crave your sweet embrace.
        </q>

        {/* Help text */}
        <p className={classes.textDescription}>Log into the desktop application with your Blockchain ID.</p>
        <p className={classes.textDescription}>
          All of your submitted insects are waiting for certification and entry into the game.
        </p>

        {/* Navigation */}
        <div className={classes.form}>
          <Button style={{ justifyContent: 'center' }} onClick={onNewPicture}>
            I found another bug!
          </Button>
          <br />
          <Button style={{ justifyContent: 'center' }} onClick={onNextGame}>
