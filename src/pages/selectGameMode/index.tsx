...
export default function SelectGameMode(): ReactElement {
  ...
  const listRewards = rewards.map((reward) =>
    <li className={ classes.rewardList }>{ reward }</li> 
  )
  ...
  return (
    <div className={classes.root}>
      <div className={classes.form}>
        ...
        <div className={classes.textHolder}>
          <p className={classes.textTitle} style={{ fontSize: 'small' }}>Rewards:</p>
          <ul>{ listRewards }</ul>
        </div>
        <div className={classes.buttonHolder}>
          ...
          <Button variant="contained" color="primary" className={classes.button} onClick={onAdjudication}>Adjudication</Button>
        </div>
      </div>
    </div>
  )
